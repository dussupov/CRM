        ...
        <View
          ...
          {active !== 0 && (
            <TouchableOpacity
              ...
              <Text style={[{color: 'white'}, buttonTextStyle]}>Назад</Text>
            </TouchableOpacity>
          )}
          {content.length - 1 !== active && (
            <TouchableOpacity
              ...
              <Text style={[{color: 'white'}, buttonTextStyle]}>Далее</Text>
            </TouchableOpacity>
          )}
          {content.length - 1 === active && (
            <TouchableOpacity
              ...
              onPress={() => onFinish()}>
              <Text style={[{color: 'white'}, buttonTextStyle]}>Записаться</Text>
            </TouchableOpacity>
          )}
        </View>
      )}
