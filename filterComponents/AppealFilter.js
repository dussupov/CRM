...
const AppealFilter = ({route}) => {
    ...
    const {Appeals, ChangeHistory} = route.params;
    ...
    const [ AppealItems, AppealSetState ] = useState(Appeals);
    ...
    const dateSort = () => {
        let result = AppealItems.filter(element => {
